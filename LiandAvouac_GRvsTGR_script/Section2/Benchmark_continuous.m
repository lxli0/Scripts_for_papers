...
for i=1:1e3
    ...
    [b_GR_est(i),loglikelihood_GR_rand]=Estimation_GR_continuous(Dm_GR,mmin_set);

    Dm_TGR=gentgr(2/3*b,L,Mmin_set,M_corner);
    [b_TGR_est(i),mcorner_TGR_est(i),loglikelihood_TGR_rand]=Estimation_TGR_gridsearch_continuous(Dm_TGR,mmin_set);
end
%delete(gcp('nocreate'))
