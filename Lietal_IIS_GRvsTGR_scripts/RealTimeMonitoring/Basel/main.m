%% Basel Magnitude Sequence Analysis
% This script analyzes magnitude data for temporal changes in earthquake size distribution
% using GR and TGR models with likelihood ratio testing.
...
for i = 1:num_windows
    ...
    if i == num_windows
        yyaxis right
        plot(x_forward_s(2:end), y_backward_s(1:end-1), '-<', 'LineWidth', 2, 'Color', 1/255*[227 162 6] );hold on;
        plot(x_forward_s, y_forward_s, '->', 'LineWidth', 2.5, 'Color',  1/255*[66 90 4] );
